...
class QuestionTest {
    ...
    @Test
    void testQuizGettersSetters() {
        Quiz quiz = new Quiz(1,"Quiz1","Quiz1 Description",45);
        question.setQuiz(quiz);
        Quiz newQuiz = question.getQuiz();
        assertNotNull(newQuiz);
        assertEquals("Quiz1", newQuiz.getTitle());
        assertEquals("Quiz1 Description", newQuiz.getDescription());
    }
