...
public class Message {
    ...
    public static final String DELETE_CATEGORY = " deleted successfully";
    ...
    public static final String DELETE_QUESTION = " deleted Successfully";
    ...
    public static final String DELETE_QUIZ = " deleted successfully";
    ...
    public static final String DELETE_USER = " deleted successfully";
