...
//the LinkedHashMap will preserve the insertion order of the key-value pairs, whereas HashMap does not guarantee any particular order.
public class LinkedHashMapCRUD {
		...
		public static void main(String[] args) {
			LinkedHashMapCRUD mapCrud = new LinkedHashMapCRUD();
